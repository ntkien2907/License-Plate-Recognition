...
def object_detection(path, filename):
    ...
    cv2.imwrite(f'{PREDICT_PATH}{filename}', image_bgr)
    return coords
...
def OCR(path, filename):
    ...
    cv2.imwrite(f'{ROI_PATH}{filename}', roi_bgr)

    pt.pytesseract.tesseract_cmd = f'C:\\Users\\{os.getlogin()}\\AppData\\Local\\Tesseract-OCR\\tesseract.exe'
